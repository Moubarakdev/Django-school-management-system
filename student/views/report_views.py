...
from student.models import AdmissionStudent
from academic.models import Department
from student.utils.helpers import render_to_pdf
...
def counsel_monthly_report(request, response_type='html', date_param=None):
    """
    Renders a template containing last month's report of counsel (admission, application related stuff).
    """
