...
from teacher.views import CreateTeacherView, TeacherListView, DeleteTeacherView, UpdateTeacherView, TeacherDetailView, \
    ...
    teacher_edit_results, TeacherRegistrationDetails, reject_teacher
...
urlpatterns = [
    ...
    path('teacher/application_details/<int:pk>', TeacherRegistrationDetails.as_view(), name="teacher_application_details"),
    path('teacher-applicants/<int:pk>/admit/', admit_teacher, name='admit_teacher'),
    path('teacher-applicants/<int:pk>/reject/', reject_teacher, name='reject_teacher'),
